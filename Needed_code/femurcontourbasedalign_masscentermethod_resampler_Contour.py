...
def main_func(fol_path,ind):
    ...
    try:
        os.mkdir(r"D:\!Crossmodality_2023\CT_npy\P%03d" %(ind))
    except:
        pass
    try:
        os.mkdir(r"D:\!Crossmodality_2023\Contour_polyvol\P%03d" %(ind))
    except:
        pass
    slice_idx = 0
    for i in range(len(rev_ct_vol)):
        ...
        im.save(os.path.join(r"D:\!Crossmodality_2023\jpgtest_scaling","%d_%d.jpg" %(ind, slice_idx)))
